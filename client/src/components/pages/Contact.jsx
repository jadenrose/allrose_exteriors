		...
		<Flexbox component="section" className="contact-section">
			<Box className="contact-info">
				...
				<a href="tel:+14033472522">
					<Flexbox className="contact-info-item">
						...
						<Box className="contact-info-text">
							<Typography component="p">403-347-2522</Typography>
				...
				<Flexbox className="contact-info-item">
					...
					<Box className="contact-info-text">
						<Typography component="p">
							<strong>Monday to Friday:</strong> 8:00 AM to 5:00
							PM
						</Typography>
						<Typography component="p">
			...
			<Box className="bottom">
				We provide insurance claim estimates. We'll work directly with
